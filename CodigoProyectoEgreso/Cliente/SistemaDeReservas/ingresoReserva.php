...
$ahora = new DateTime();
$tempo = (clone $ahora)->modify("+1 hour");
     ...
     //Server settings
            $mail->isSMTP();
                ...
                $mail->Body    = "Hola {$usuario['nombre']},<br><br>
                                Por favor, presione el link para confirmar su reserva, solo si ya está seguro de ello.<br>
                                <a href='$resetLink'>$resetLink</a><br><br>
                                Si no solicitó una reserva, ignore este correo.";
